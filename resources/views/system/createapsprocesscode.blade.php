            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="{{ route('aps-processcode.store')}}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label class="col-md-2 control-label">APS製程碼</label>
                                <div class="col-md-4">
                                    <input name="aps_process_code" class="clearable form-control" onkeyup="value=value.replace(/[^\d]/g,'')"  maxlength="4"required>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input name="process_description" class="clearable form-control" required>
                                </div>
                            </div>
                            <hr>
