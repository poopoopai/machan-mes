            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" action="{{ route('variable-formula.update', $datas->id) }}" method="POST">
                            @csrf
                            @method("PUT")
                            <div class="form-group">
                                <label class="col-md-2 control-label">變數代碼</label>
                                <div class="col-md-10">
                                <input type="text" name='variable' value={{$datas->variable}} class="form-control" required>
                                </div>
                            </div>
                            <hr>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name='variablename' value={{$datas->variablename}} class="form-control" required>
                                </div>
                            </div>
                            <hr>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea style="resize: none;" name="remark"   id="" cols="90" rows="5">{{$datas->remark}}</textarea>
                                </div>
                            </div>
                            <hr>
